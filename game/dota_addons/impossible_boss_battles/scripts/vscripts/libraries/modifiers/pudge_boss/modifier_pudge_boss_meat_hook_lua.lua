modifier_pudge_boss_meat_hook_lua = class({})
--------------------------------------------------------------------------------

function modifier_pudge_boss_meat_hook_lua:IsDebuff()
	return true
end

--------------------------------------------------------------------------------

function modifier_pudge_boss_meat_hook_lua:IsStunDebuff()
	return true
end

--------------------------------------------------------------------------------

function modifier_pudge_boss_meat_hook_lua:RemoveOnDeath()
	return false
end

--------------------------------------------------------------------------------

function modifier_pudge_boss_meat_hook_lua:OnCreated( kv )
	if IsServer() then
		if self:ApplyHorizontalMotionController() == false then 
			self:Destroy()
		else
			self:GetParent():AddAbility("pudge_boss_meat_hook_splinter_lua")
			self:GetParent():FindAbilityByName( "pudge_boss_meat_hook_splinter_lua" ):SetLevel(1)
			--[[self:GetParent():CastAbilityNoTarget( self:GetParent():FindAbilityByName( "pudge_boss_meat_hook_splinter_lua" ), self:GetParent():GetPlayerOwnerID() )]]
			self:GetParent():CastAbilityNoTarget( self:GetParent():FindAbilityByName( "pudge_boss_meat_hook_splinter_lua" ), self:GetParent():GetPlayerOwnerID() )
		end
	end
end
...
function modifier_pudge_boss_meat_hook_lua:DeclareFunctions()
	local funcs = {
...
function modifier_pudge_boss_meat_hook_lua:GetOverrideAnimation( params )
	return ACT_DOTA_FLAIL
end

--------------------------------------------------------------------------------

function modifier_pudge_boss_meat_hook_lua:CheckState()
	if IsServer() then
...
function modifier_pudge_boss_meat_hook_lua:UpdateHorizontalMotion( me, dt )
	if IsServer() then
...
--------------------------------------------------------------------------------
function modifier_pudge_boss_meat_hook_lua:OnHorizontalMotionInterrupted()
	if IsServer() then
		if self:GetAbility().hVictim ~= nil then
