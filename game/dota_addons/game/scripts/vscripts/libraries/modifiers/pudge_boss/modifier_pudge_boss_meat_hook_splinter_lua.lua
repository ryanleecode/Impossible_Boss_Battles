modifier_pudge_boss_meat_hook_splinter_lua = class({})
--------------------------------------------------------------------------------

function modifier_pudge_boss_meat_hook_splinter_lua:IsDebuff()
	return true
end

--------------------------------------------------------------------------------

function modifier_pudge_boss_meat_hook_splinter_lua:IsStunDebuff()
	return true
end

--------------------------------------------------------------------------------

function modifier_pudge_boss_meat_hook_splinter_lua:RemoveOnDeath()
	return false
end

--------------------------------------------------------------------------------

function modifier_pudge_boss_meat_hook_splinter_lua:OnCreated( kv )
	if IsServer() then
...
function modifier_pudge_boss_meat_hook_splinter_lua:DeclareFunctions()
	local funcs = {
...
function modifier_pudge_boss_meat_hook_splinter_lua:GetOverrideAnimation( params )
	return ACT_DOTA_FLAIL
end

--------------------------------------------------------------------------------

function modifier_pudge_boss_meat_hook_splinter_lua:CheckState()
	if IsServer() then
...
function modifier_pudge_boss_meat_hook_splinter_lua:UpdateHorizontalMotion( me, dt )
	if IsServer() then
...
--------------------------------------------------------------------------------
function modifier_pudge_boss_meat_hook_splinter_lua:OnHorizontalMotionInterrupted()
	if IsServer() then
		if self:GetAbility().hVictim ~= nil then
